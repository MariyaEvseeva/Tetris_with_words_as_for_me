...
class HELLO_PYGAME(object):
    ...
    def addText2(self):
        self.screen.blit(self.font.render(
            'Приветствуем вас в приложении World Of Words!',
            True, (0, 0, 0)), (100, 220))

        self.screen.blit(self.font.render(
            'На этот раз мы подготовили для пользователей кое-что интересное.',
            True, (0, 0, 0)), (10, 250))

        self.screen.blit(self.font.render(
            'Вам предстоит показать незаурядный словарный запас и скорость!',
            True, (0, 0, 0)), (10, 280))

        self.screen.blit(self.font.render(
            'Вовремя "ловите" буквы, чтобы составить слова. Звучит трудно?',
            True, (0, 0, 0)), (10, 310))
